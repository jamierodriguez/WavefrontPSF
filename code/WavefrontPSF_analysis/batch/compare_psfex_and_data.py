...
Code below should download image and create psf, val, sel catalogs for one
expid. (So it's like a combination of the assemble_psfex and
do_PsfCat_and_Validation codes.)

I will need a driver code that also can create the list of images (by doing a
query of some kind to desdm for the image numbers.)
