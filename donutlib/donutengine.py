...
class DonutEngine(_object):
    ...
    def __init__(self, *args): 
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            ...
            int zemaxToDECamSignFlip = -1) -> DonutEngine
        Parameters:
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            ...
            int printLevel = 0, bool gridCalcMode = True, 
            int pixelOverSample = 4, 
            double scaleFactor = 2.0, char inputPupilMask = "") -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            ...
            int printLevel = 0, bool gridCalcMode = True, 
            int pixelOverSample = 4, 
            double scaleFactor = 2.0) -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            ...
            char outputPrefix = "test", bool debugFlag = False, 
            int printLevel = 0, bool gridCalcMode = True, 
            int pixelOverSample = 4) -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            int nbin = 256, int nPixels = 64, 
            char outputPrefix = "test", bool debugFlag = False, 
            int printLevel = 0, bool gridCalcMode = True) -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            int nbin = 256, int nPixels = 64, 
            char outputPrefix = "test", bool debugFlag = False) -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            int nbin = 256, int nPixels = 64, 
            char outputPrefix = "test") -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11, 
            int nbin = 256, int nPixels = 64) -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9, int nZernikeTerms = 11) -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
           nZernikeTerms: int value
        ...
        __init__(self, int iTelescope = 0, double waveLength = 700.0e-9) -> DonutEngine
        Parameters:
           iTelescope: int value
           waveLength: double value
        ...
        __init__(self, int iTelescope = 0) -> DonutEngine
        Parameters:
           iTelescope: int value

           iTelescope: int value

        __init__(self) -> DonutEngine
        """
    ...
    def calcWFMtoImage(self, *args):
        """
        calcWFMtoImage(self, Real par)
        Parameters:
           par: Real * value

           par: Real * value

        calcWFMtoImage(self, double par)
        Parameters:
           self: DonutEngine * value
           par: double * value
    ...
    def calcPsfToImage(self, *args):
        """
        calcPsfToImage(self, Real par)
        Parameters:
           par: Real * value

           par: Real * value

        calcPsfToImage(self, double par)
        Parameters:
           self: DonutEngine * value
           par: double * value
